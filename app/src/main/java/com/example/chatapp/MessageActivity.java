                            ...
                            .enqueue(new Callback<MyResponse>() {
                                ...
                                public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                    if (response.code() == 200){
                                        ...
                                        Toast.makeText(MessageActivity.this, "Success Notify", Toast.LENGTH_SHORT).show();
                                    }
                                }
    ...
    private void readMessage(final String myid, final String userid, final String imageurl)
    {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot :dataSnapshot.getChildren())
                {
                    Chat chat=snapshot.getValue(Chat.class); // bb == na && na == bb || bb == bb && na == na
                    if (chat.getReceiver().equals(myid) && chat.getSender().equals(userid) ||
                            chat.getReceiver().equals(userid) && chat.getSender().equals(myid))
                    {
                        nChat.add(chat);
                    }
                    messageAdapter=new MessageAdapter(MessageActivity.this,nChat,imageurl);
